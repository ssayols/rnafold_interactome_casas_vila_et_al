...
## Validation of candidates from 120 yeast RBPs from Parker
##
########################
library(ggplot2)
library(VennDiagram)
...
# validation against Parker's db
img <- venn.diagram(list(Parker=parker$Systematic.Name, Gerber=gerber$ORF, Casas=binders$X),
